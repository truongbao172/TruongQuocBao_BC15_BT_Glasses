...
export default class StateDemo extends Component {
    ...
    //this.state là thuộc tính có sẵn của react class component, Dùng để chứa các giá trị thay đổi trên giao diện khi người dùng thao tác (click, change, blur ...)
    state = {
        login: false
    }
                ...
                <nav className="navbar navbar-expand-sm navbar-dark bg-dark">
                    ...
                    <div className="collapse navbar-collapse" id="collapsibleNavId">
                        ...
                        <form className="form-inline my-2 my-lg-0">
                            {/* {this.renderLogin()} */}
                            {this.state.login ? <span className="nav-item text-white">Hello ! {this.userName}</span> : <button className="nav-item btn btn-success" onClick={()=>{
                                this.handleLogin();
                            }}>
                                Đăng nhập
                            </button>}
